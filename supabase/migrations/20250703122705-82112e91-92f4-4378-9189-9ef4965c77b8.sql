-- Fix the generate_weekly_snapshots function for proper cumulative scoring
-- This addresses the critical bug where Week 2+ snapshots were identical to Week 1
