-- COMPLETE SEASON 27 REBUILD - OFFICIAL CAST WITH CORRECT PHOTOS
-- This migration creates the definitive Season 27 global defaults

-- Step 1: Ensure default groups exist (using WHERE NOT EXISTS)
...
-- Step 2: Insert the complete Season 27 cast with correct photos
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group A' LIMIT 1), 
 ...
 'A Texas carpenter whose hands-on craftsmanship and work ethic drive him to succeed in any challenge.',
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTgx/season-27-contestant-gallery.jpg', 27, true, 1, 'bb27_official_cast', false),

(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group A' LIMIT 1), 
 'Amy Wilson', 25, 'Nashville, TN', 'Music Teacher', 
 'A passionate music teacher from Nashville who brings creativity and harmony to every situation.',
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTgy/season-27-contestant-gallery.jpg', 27, true, 2, 'bb27_official_cast', false),
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group A' LIMIT 1), 
 ...
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTgz/season-27-contestant-gallery.jpg', 27, true, 3, 'bb27_official_cast', false),

(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group A' LIMIT 1), 
 'Ava Chen', 22, 'Los Angeles, CA', 'College Student', 
 'A determined college student from Los Angeles ready to prove that age is just a number in strategic gameplay.',
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTg0/season-27-contestant-gallery.jpg', 27, true, 4, 'bb27_official_cast', false),
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group B' LIMIT 1), 
 ...
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTg2/season-27-contestant-gallery.jpg', 27, true, 6, 'bb27_official_cast', false),
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group C' LIMIT 1), 
 ...
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTkz/season-27-contestant-gallery.jpg', 27, true, 12, 'bb27_official_cast', false),
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group D' LIMIT 1), 
 ...
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTk0/season-27-contestant-gallery.jpg', 27, true, 13, 'bb27_official_cast', false),
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group D' LIMIT 1), 
 ...
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTk2/season-27-contestant-gallery.jpg', 27, true, 15, 'bb27_official_cast', false),
...
(NULL, (SELECT id FROM contestant_groups WHERE pool_id IS NULL AND group_name = 'Group D' LIMIT 1), 
 ...
 'https://parade.com/.image/w_750,q_auto:good,c_limit/ODowMDAwMDAwMDAwODU3NTk3/season-27-contestant-gallery.jpg', 27, true, 16, 'bb27_official_cast', false);