...
-- Fixed order: Delete contestants first, then groups

-- Step 1: Delete ALL Season 27 contestants first (to avoid foreign key constraint)
DELETE FROM contestants WHERE season_number = 27;

-- Step 2: Delete global contestant groups
DELETE FROM contestant_groups WHERE pool_id IS NULL;

-- Step 3: Create fresh global default groups (pool_id = NULL)
...
-- Step 4: Insert the REAL BB27 cast as global defaults (pool_id = NULL)
